  ...
  return (
    <div className="min-h-screen bg-[#fdf8f5] px-6 py-12 md:px-24">
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-12 text-gray-700">
        ...
        {/* Address */}
        <div className="space-y-2">
          <p>📍 221B Elementary Street<br />New York, NY</p>
        </div>
      </div>

      {/* Contact Form */}
      <form ref={form} onSubmit={sendEmail} className="grid md:grid-cols-2 gap-6 bg-white p-6 shadow-lg rounded-lg mb-12">
        ...
        <div className="flex flex-col">
          ...
          <input type="text" name="full_name" placeholder="Enter your full name" className="border p-2 rounded" required />
        </div>

        <div className="flex flex-col">
          <label>Email Address</label>
          <input type="email" name="email" placeholder="Enter your email address" className="border p-2 rounded" required />
        </div>

        <div className="flex flex-col">
          <label>Organization</label>
          <input type="text" name="organization" placeholder="Enter your organization" className="border p-2 rounded" />
        </div>

        <div className="flex flex-col">
          <label>Phone Number</label>
          <input type="tel" name="phone" placeholder="Enter your phone number" className="border p-2 rounded" />
        </div>

        <div className="md:col-span-2 flex flex-col">
          <label>Message</label>
          <textarea name="message" placeholder="Enter your message here..." className="border p-2 rounded h-32" required></textarea>
        </div>
